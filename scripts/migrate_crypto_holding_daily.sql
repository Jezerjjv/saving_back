-- Historial diario por posición (por crypto): G/P al cierre de cada día.
...
COMMENT ON TABLE crypto_holding_daily IS 'G/P acumulado por holding al cierre de cada día; la G/P del día = diferencia con el día anterior';
